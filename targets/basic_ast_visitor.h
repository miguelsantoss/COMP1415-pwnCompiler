// $Id: basic_ast_visitor.h,v 1.7 2015/04/14 13:35:09 ist175551 Exp $ -*- c++ -*-
...
public:
  ...
  virtual void do_function_define_node(pwn::function_define_node * const node, int lvl) = 0;
  ...
  virtual void do_memory_node(pwn::memory_node * const node, int lvl) = 0;
  ...
  virtual void do_qmark_node(pwn::qmark_node * const node, int lvl) = 0;
